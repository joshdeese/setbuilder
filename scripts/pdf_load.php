...
<script type="text/javascript">
	var uploader = $('<div>').append($('<form>').attr('id', 'imageform').attr('method', 'post').attr('enctype', 'multipart/form-data').attr('action', '/scripts/ajaximage.php').append($('<input>').attr('type', 'file').attr('name', 'photoimg').attr('id', 'photoimg').css('width', 250))).append($('<div>').attr('id', 'preview'));
